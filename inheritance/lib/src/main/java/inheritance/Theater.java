...
public class Theater extends Place {
    ...
    public String toString() {
            if (getReview().isEmpty()) {
                return "Theater name: " + getName() + ", Total Rate: " + getStars() + ", Today's Movies: " + moviesList + ", Review: No review added.";
            } else {
                return "Theater name: " + getName() + ", Total Rate: " + getStars() + ", Today's Movies: " + moviesList +  ", Review: " + getReview();
            }
